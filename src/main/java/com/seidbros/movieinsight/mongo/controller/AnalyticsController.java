...
import com.seidbros.movieinsight.mongo.service.AnalyticsService;
...
public class AnalyticsController {
    ...
    @GetMapping("genreTitleCount")
    public ResponseEntity<?> genreTitleCount() {
        BaseList<?> genreTitleCount = analyticsService.getGenreTitleCount();
        return baseService.restList(genreTitleCount);
    }

    @GetMapping("topN")
    public ResponseEntity<?> topN(@RequestParam("top") int top){
        BaseList<?> topNMovies = analyticsService.getTopNMovies(top);
        return baseService.restList(topNMovies);
    }
}
