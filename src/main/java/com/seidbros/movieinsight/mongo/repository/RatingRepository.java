...
import com.seidbros.movieinsight.mongo.dto.RatingsPerYear;
import com.seidbros.movieinsight.mongo.dto.YearlyAverageRating;
...
public interface RatingRepository extends MongoRepository<Rating, String> {
    ...
    List<Rating> findRatingsByUserIdIn(List<String> userIds);
}
